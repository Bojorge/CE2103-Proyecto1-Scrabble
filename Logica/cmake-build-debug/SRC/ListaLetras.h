...
#ifndef TC_LISTALETRAS_H
#define TC_LISTALETRAS_H
...
public: ListaLetras(){
    ...
    for(int i = 0; i < 12 ; i++){
        listaLetras->anadir_final(1);listaLetras->anadir_final(5);
            ...
            listaLetras->anadir_final(10);listaLetras->anadir_final(22);
    }for(int k = 0; k < 5 ; k++){
        listaLetras->anadir_final(4);listaLetras->anadir_final(15);listaLetras->anadir_final(20);listaLetras->anadir_final(24);
    }for(int n = 0; n < 4 ; n++){
            listaLetras->anadir_final(3);listaLetras->anadir_final(12);listaLetras->anadir_final(23);
    }for(int l = 0; l < 2 ; l++){
            listaLetras->anadir_final(7);listaLetras->anadir_final(2);listaLetras->anadir_final(8);listaLetras->anadir_final(14);
            listaLetras->anadir_final(18);listaLetras->anadir_final(29);
    }       listaLetras->anadir_final(6);listaLetras->anadir_final(9);listaLetras->anadir_final(11);listaLetras->anadir_final(13);
            listaLetras->anadir_final(16);listaLetras->anadir_final(19);listaLetras->anadir_final(21);listaLetras->anadir_final(25);
            listaLetras->anadir_final(26);listaLetras->anadir_final(27);listaLetras->anadir_final(28);
    ...
    tS.anadir_final("r");tS.anadir_final("rr");tS.anadir_final("s");tS.anadir_final("t");tS.anadir_final("u");
    tS.anadir_final("v");tS.anadir_final("x");tS.anadir_final("y");tS.anadir_final("z");tS.anadir_final(" ");

    tP.anadir_final(0);tP.anadir_final(1);tP.anadir_final(3);tP.anadir_final(3);tP.anadir_final(2);
    tP.anadir_final(1);tP.anadir_final(4);tP.anadir_final(2);tP.anadir_final(4);tP.anadir_final(5);
    tP.anadir_final(1);tP.anadir_final(8);tP.anadir_final(1);tP.anadir_final(8);tP.anadir_final(3);
    tP.anadir_final(1);tP.anadir_final(8);tP.anadir_final(1);tP.anadir_final(3);tP.anadir_final(5);
    tP.anadir_final(1);tP.anadir_final(8);tP.anadir_final(1);tP.anadir_final(1);tP.anadir_final(1);
    tP.anadir_final(4);tP.anadir_final(8);tP.anadir_final(4);tP.anadir_final(10);tP.anadir_final(0);
...
public: string traducir(int num){
...
public: bool verificar_Palabra(string pal){
